        ...
        case 'l':
        {
            ...
            if (library != "teseo" && library != "graphone" && library != "llama" && library != "stinger")
            {
                cerr << "ERROR: Invalid library: `" << library
                     << "'. Only \"teseo\", \"graphone\", \"llama\" and \"stinger\" "
                        "are supported."
                     << endl;
            }
            g_library = library;
...
static string string_usage(char * program_name)
{
    ...
    ss << "  -l <library> is the library to execute. Only \"teseo\" (default), "
          "\"graphone\", \"llama\" and \"stinger\" are supported\n";
