...
#define COUT_DEBUG_FORCE(msg)                                                      \
    {                                                                              \
        std::cout << "[PlainReader::" << __FUNCTION__ << "] " << msg << std::endl; \
    }
#if defined(DEBUG)
 ...
 *                                                                           *
 *****************************************************************************/
PlainReader::PlainReader(const std::string & path, bool is_weighted)
    : PlainReader(path, is_weighted, configuration().max_weight())
{}
