...
std::ostream & operator<<(std::ostream & out, RequestType type)
{
    ...
    case RequestType::BATCH_PLAIN_FORCE_NO:
        out << "BATCH_PLAIN (force = false)";
        break;
    case RequestType::BATCH_PLAIN_FORCE_YES:
        out << "BATCH_PLAIN (force = true)";
        break;
    ...
    case RequestType::DUMP_CLIENT:
        out << "DUMP_CLIENT";
        break;
    case RequestType::DUMP_STDOUT:
        out << "DUMP_STDOUT";
        break;
    case RequestType::DUMP_FILE:
        out << "DUMP_FILE";
        break;
    case RequestType::BFS:
        out << "BFS (Graphalytics, Breath First Search)";
        break;
    case RequestType::PAGERANK:
        out << "PAGERANK (Graphalytics)";
        break;
    case RequestType::WCC:
        out << "WCC (Graphalytics, Weakly Connected Components)";
        break;
    case RequestType::CDLP:
        out << "CDLP (Graphalytics, Community Detection using Label Propagation)";
        break;
    case RequestType::LCC:
        out << "LCC (Graphalytics, Local Clustering Coefficient)";
        break;
    case RequestType::SSSP:
        out << "SSSP (Graphalytics, Single-Source Shortest Paths)";
        break;
    default:
        out << "UNKNOWN (request code: " << (uint32_t)type << ")";
    }
    return out;
}
...
std::ostream & operator<<(std::ostream & out, ResponseType type)
{
    ...
    case ResponseType::NOT_SUPPORTED:
        ...
        break;
    default:
        out << "UNKNOWN (response code: " << (uint32_t)type << ")";
    }
    return out;
}
